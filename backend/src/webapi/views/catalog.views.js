    ...
    <div class="space-y-6">
      ...
      <div>
        <h1 class="text-2xl font-black text-gray-900 tracking-tight flex items-center space-x-2">
          ...
          <span>Catálogo de Insumos y Destinos</span>
        </h1>
        <p class="text-sm text-gray-500 mt-1">Estandarizar los insumos y registrar los destinos oficiales de entrega.</p>
      </div>
        ...
        <div class="lg:col-span-1 space-y-6">
          ...
          <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 space-y-4 relative overflow-hidden">
            ...
            <div>
              ...
              <p class="text-xs text-gray-400">Añadir artículo estandarizado al catálogo.</p>
            </div>
