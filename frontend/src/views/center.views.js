...
function newCenterForm() {
  return `
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 space-y-6 transition duration-200">
      ...
      <form hx-post="/api/admin/centers" 
        ...
        <div>
          ...
          <input type="text" name="address" id="address" required placeholder="Ej. Av. Principal 123, Col. Centro"
                 class="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:bg-white transition" />
        </div>
        ...
        <div class="flex items-center space-x-3 pt-2">
          <button type="submit" 
                  class="flex-1 bg-blue-600 hover:bg-blue-700 text-white font-medium py-2.5 px-4 rounded-xl shadow-sm hover:shadow transition flex items-center justify-center space-x-2">
          ...
          <button type="button" 
                  ...
                  class="bg-gray-100 hover:bg-gray-200 text-gray-600 font-medium py-2.5 px-4 rounded-xl transition">
            Cancelar
          </button>
        </div>
      </form>
      ...
      <tr class="hover:bg-gray-50/70 border-b border-gray-100 transition duration-150">
        ...
        <td class="px-6 py-4 whitespace-nowrap text-right text-sm">
          <button hx-get="/api/admin/centers/${center.id}/edit" 
                  ...
                  hx-swap="innerHTML"
                  class="text-blue-600 hover:text-blue-800 font-semibold transition flex items-center justify-end space-x-1.5 ml-auto group">
    ...
    <div class="space-y-6">
      <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-4 sm:space-y-0">
        ...
        <button hx-get="/api/admin/centers/new" 
                hx-target="#center-form-container" 
                hx-swap="innerHTML" 
                class="inline-flex items-center justify-center space-x-2 bg-blue-600 hover:bg-blue-700 text-white font-medium py-2.5 px-5 rounded-xl shadow-sm hover:shadow transition duration-150">
